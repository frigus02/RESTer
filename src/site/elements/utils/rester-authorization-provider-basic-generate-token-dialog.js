 ...
 * @customElement
 */
class RESTerAuthorizationProviderBasicGenerateTokenDialog extends RESTerDialogControllerMixin(PolymerElement) {
    static get template() {
        return html`
            <style>
                paper-dialog {
...
customElements.define(RESTerAuthorizationProviderBasicGenerateTokenDialog.is, RESTerAuthorizationProviderBasicGenerateTokenDialog);
