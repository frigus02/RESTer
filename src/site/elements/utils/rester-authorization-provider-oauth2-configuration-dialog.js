        ...
        <paper-dialog-scrollable>
            ...
            <iron-form id="dialogForm">
                <form>
                    ...
                    ></paper-input>
                    <div class="hint">
                        A name for this configuration, only used to identify the
                        config in RESTer.
                    </div>
                    ...
                    >
                        ...
                        >
                            ...
                            <paper-item value="resource_owner"
                                >Resource Owner Password Credentials</paper-item
                            >
                        </paper-listbox>
                    </paper-dropdown-menu>
                    <paper-input
                    ...
                    >
                        ...
                        >
                            ...
                            >
                            <paper-item value="basic-noencode">
                                <paper-item-body two-line>
                                    <div>
                                        HTTP Basic authentication (no encode)
                                    </div>
                                    <div secondary>
                                        Don't URL-encode client ID and secret
                                        (required for some OAuth 2 servers)
                                    </div>
                                </paper-item-body>
                            </paper-item>
                    ...
                    ></paper-input>
                    <div class="hint">
                        Please provide any valid redirect uri for the OAuth 2
                        client. When this URL is loaded, RESTer will grab the
                        access token from the URL and finish the authorization
                        flow.
                    </div>
                    <paper-input
