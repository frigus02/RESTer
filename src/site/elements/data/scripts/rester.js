(function () {
    ...
    const requests = {};
    const settingsKeys = ['activeEnvironment', 'stripDefaultHeaders', 'enableRequestLintInspections', 'pinSidenav', 'responseBodyWrap', 'responseBodyPrettyPrint', 'responseBodyFullSize', 'responseBodyPreview'];
